...
/**
 * The Company Action Center (/today) must answer, for a real seeded
 * exception: what needs attention, why, the impact, what to do, who owns
 * it, and when it's due — not just repeat the bare alert list /alerts used
 * to (that route now redirects here).
 */
test.describe("Company Action Center", () => {
